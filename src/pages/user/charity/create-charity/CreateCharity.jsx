...
const CreateCharity = () => {
   ...
   const subCategoryOptions = [
      { id: 1, title: 'Выберите подкатегорию' },
      { id: 2, title: 'Смартфоны и телефоны' },
      { id: 3, title: 'Аудиотехника' },
      { id: 4, title: 'Фото и видеокамеры' },
      { id: 5, title: 'Автоэлектроника' },
      { id: 6, title: 'ТВ и видео' },
      { id: 7, title: 'Компьютеры, ноутбуки и планшеты' },
   ]
