...
import CharityList from '../components/UI/charity/CharityList'
import CharityDescription from '../components/UI/charity/CharityDescription'
...
const AppRouter = () => (
   <Routes>
      ...
      >
         ...
         <Route path="charity/:id" element={<CharityDescription />} />
